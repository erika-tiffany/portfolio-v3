export const HOME = {
  ...
  projects: [
    ...
    },
    {
      ...
      technologies: ['React', 'Sketch', 'Amazon Web Services'],
...
export const MAGNITY_APP = {
  ...
  intro: {
    ...
    text: [
      '<a href="//www.magnity.io" target="_blank" rel="noopener noreferrer" style="color:#F6CE82">Magnity</a> was a project where I was involved in the full life cycle of the web application including design, front-end development, back-end development, cloud architecture and deployment.',
  ...
  development: {
    ...
    facets: [
      ...
      },
      {
        ...
        title: 'Vue.js',
        text: [
          'Vue was the front-end framework that shined in Magnity’s digest builder. Using a JavaScript framework meant that I could achieve a design tool that provides a highly interactive experience that served and updated data asynchronously via an organised set of components.',
          'Integration with a few existing libraries for key functionality via npm and then building via webpack avoided reinventing the wheel. This included a library that allowed a user to move a vue component around the page (dragging), wysiwygs and also integration with the Unsplash API so users can search the awesome pool of royalty free images',
      ...
      },
      {
        ...
        text: [
          'Magnity integrated with API’s including Intercom, Unsplash, TinyPng, Stripe and Bugsnag. Whether getting data or pushing data to other services, API integration was at the forefront of building Magnity.',
          'Intercom was the most pivotal API integration as Magnity created custom digests based on users Intercom event data. This involved authentication handling and importing and processing a large amount of data.',
      ...
      },
      {
        ...
        title: 'Webhooks',
        text: [
          'Magnity integrates with webhooks provided by Intercom and Stripe. This is so we can fire off certain jobs off certain events triggered within the corresponding applications.',
      ...
      // },
      {
        ...
        text: [
          ...
          'The biggest challenge with PDF generation is the translation of the web CSS into PDF friendly CSS - which is very restrictive compared to the latter. This required quite a bit of creativity on my end.',
      ...
      },
      {
        ...
        text: [
          'As for most projects, Magnity required a version control system for the code base - hence the use of Git.',
    ...
    facets: [
      {
        ...
        text: [
          ...
          'The EB CLI provided an intuitive command line that uploaded the most recent commit of your git repository and re-deploys all your EC2 instances with the updated application code.',
        ]
      },
      {
        icons: ['AWS VPC'],
      ...
      },
      {
        ...
        title: 'ElastiCache',
        text: [
          'ElastiCache(caching-as-a-service) offered Magnity solutions for it’s caching and session management through Redis.',
          'Because Elastic Beanstalk was being used, and taking advantage of EB’s autoscaling where servers will be provisioned and destroyed based on traffic load, Magnity required a service where all the instances could read and write from the same cache. Therefore Redis caching via ElastiCache was a straightforward service to integrate with our existing architecture.',
          'Magnity also required distributed session management, therefore opted to use Redis engines again - using cache for session management.'
        ]
      },
      {
        icons: ['AWS SQS'],
...
export const MAGNITY_WEB = {
  ...
  intro: {
    ...
    subheading: 'A Brief Overview.',
    text: [
      'I was involved and spearheaded the design, development and deployment of this <a href="//www.magnity.io" target="_blank" rel="noopener noreferrer" style="color:#EB457B">project</a>.',
    ...
    facets: [
      {
        ...
        text: [
          'To assist in appearing in organic, unpaid search engine ranking, I implemented a variety of best practises for organic SEO. This is so the website had a good foundation which at its base appeared favourable to search engine bots.',
...
export const BOARDINGWARE = {
  ...
  intro: {
    ...
    subheading: 'A Brief Overview.',
    text: [
      '<a href="//www.boardingware.com" target="_blank" rel="noopener noreferrer" style="color:#1C4891">Boardingware</a> is a boarding school management system that spans across multiple platforms and applications. I was contracted to implement a major redesign of their web application. This mainly involved building html structure via Jade templates, CSS and a touch of Javascript for their existing platform.',
...
export const FUSION = {
  ...
  intro: {
    ...
    subheading: 'A Brief Overview.',
    text: [
      '<a href="//www.fusionentertainment.com" rel="noopener noreferrer" target="_blank" style="color:#80FF06">Fusion Entertainment</a> are leaders in creating audio equipment such as speakers, subwoofers and amplifiers for Marine and Lifestyle entertainment. I was contracted to assist their team in building the marketing teams ecosystem via back-end development of their website.',
      'Fusion’s marketing website is built on the Craft CMS, which gave me the opportunity to expand my experience and knowledge surrounding custom CMS module development - improving on my previous work with Drupal 7 (<a href="/projects/ljhooker" target="_blank" rel="noopener noreferrer" style="color:#F0231E">LJ Hooker</a>, <a href="/projects/pasifikatv" target="_blank" rel="noopener noreferrer" style="color:#06BDB4">Pasifika TV</a>). This resulted in heavy PHP development with a great emphasis on implementing API Integrations throughout the contract.',
      'Craft CMS is built on top of the Yii2 PHP framework, this was a first as most of my other projects have been based on the Symfony PHP framework. Unlike Drupal, with Craft custom development, referring to Yii2 often yielded more instructive results, therefore I was able to grow and expand my familiarity with the framework.',
      'During my contract I was involved in:',
      '<ul><li>Developing a portal for Fusion dealers to access, search and download a pool of resources. This entailed tight integration with a few API’s and implementing functionality to download a large number of resources at a single time.</li><li>Developing a portal for their Dealers which involved a multi-tier user registration flow and integrations with their Learning Management System via their API and webhooks.</li><li>Automating a few manual processes through API Integrations and scheduled tasks such as cache clean up.</li></ul>'
    ],
    tags: [
      'Back-end Development',
      'Webhooks',
  ...
  development: {
    ...
    facets: [
      ...
      },
      {
        ...
        text: [
          'As with most content management systems, modules and plugins house most, if not all of the customisations. Therefore the biggest focus of my contract was implementing all the required features, customisations and extensions for Fusions marketing ecosystem within Craft’s module and plugin ecosystem. Although different to Drupal custom module development, I was able to take that knowledge to provide a base grounding and go forth from there with great upskilling in learning Yii2.'
        ]
      },
      {
        icons: ['Imgix'],
  ...
  figures: [
    {
      heading: 'Resource Centre Landing Page',
      subheading: 'Quick links and recent files',
      path: '/FusionEntertainment/cSUqxneTRNBhbr9gHjk9-002_w-1000px_compressed.png',
      auto: true,
    },
    {
      heading: 'Resource Centre Search Results',
      subheading: 'Series category search list view',
      path: '/FusionEntertainment/jBR8nm89qy4DkqYJbhUM-003_w-1000px_compressed.png',
    },
    {
      heading: 'Resource Centre Search Results',
      subheading: 'Marketing product imagery search grid view',
      path: '/FusionEntertainment/kuHKB4GQaUFNjCyhjahu-004_w-1000px_compressed.png',
      auto: true,
    },
  ]
}
...
export const LJHOOKER = {
  ...
  intro: {
    ...
    subheading: 'A Brief Overview.',
    text: [
      'The <a href="//www.ljhooker.co.nz" target="_blank" rel="noopener noreferrer" style="color:#F0231E">LJ Hooker NZ</a> website was a re-implementation, an improvement, on their old website during my time at Applicable. My role with this project was to:',
    ...
    facets: [
      ...
      },
      {
        ...
        text: [
          ...
          'I had to build my knowledge on the Drupal module file organisation, available Drupal hooks and understand which points of the thread of execution to interact with.',
...
export const PASIFIKA_TV = {
  ...
  intro: {
    ...
    text: [
      ...
      'While all users could see the upcoming broadcast, there were also requirements specific for broadcasters in the Pacific. This included the ability to be able request shows, request access to one-time events such as sports games etc.. therefore there was a fair bit of setting up/planning around the user groups and permissions for each tier.',
